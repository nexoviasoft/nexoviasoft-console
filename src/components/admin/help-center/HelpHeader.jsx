...
export default function HelpHeader() {
  return (
    <div className="glass-card rounded-2xl p-8 mb-10 text-white border border-white/20 relative overflow-hidden">
       ...
       <div className="relative z-10 max-w-2xl mx-auto text-center">
         ...
         <div className="mt-6 flex items-center justify-center gap-2 text-sm text-white/70">
            ...
            <span className="bg-white/10 px-3 py-1 rounded-full cursor-pointer hover:bg-white/20 transition-colors text-white">Reset Password</span>
            <span className="bg-white/10 px-3 py-1 rounded-full cursor-pointer hover:bg-white/20 transition-colors text-white">Payroll</span>
            <span className="bg-white/10 px-3 py-1 rounded-full cursor-pointer hover:bg-white/20 transition-colors text-white">Leave Policy</span>
         </div>
       </div>
    </div>
  );
