    ...
    return (
        <div className={`flex flex-col gap-2 ${className}`}>
            ...
            <textarea
                ...
                className={`bg-black/40 border border-white/20 text-white placeholder:text-white/40 focus-visible:ring-[#F58220] py-2.5 px-4 rounded-[6px] w-full outline-none resize-vertical min-h-[80px] ${disabled && "bg-gray-400"
